...
bucket_name = "given-cingco-sports-analytics-data-lake"  # Change to a unique S3 bucket name
glue_database_name = "glue_nba_data_lake"
athena_output_location = f"s3://{bucket_name}/athena-results/"

# Sportsdata.io configurations (loaded from .env)
api_key = os.getenv("6ea59c1cd1944325b2566f9ef7101e8d")  # Get API key from .env
nba_endpoint = os.getenv("https://api.sportsdata.io/v3/nba/scores/json/Players")  # Get NBA endpoint from .env
